...
def main():
    ...
    query_to_reference_df.to_csv(f"{temp_dir}/query_to_reference.csv", index=False)
    similarity_score_df.to_csv(f"{temp_dir}/similarity_score.csv", index=False)
    blast_score_df.to_csv(f"{temp_dir}/blast_score.csv", index=False)
    mibig_entries_df.to_csv(f"{temp_dir}/mibig_entries.csv", index=False)
